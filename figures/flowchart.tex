...
\begin{tikzpicture}[node distance = 1.8cm, auto]  
    ...
    \node [io, text width=2cm, align=center] (directdata) [below = 1cm of decision1] {Data $\boldsymbol{d}=\{d_1, ..., d_n\}$}; 
    ...
    ([shift={(0em, 1.7ex)}]cov.north west)
    -| ([shift={(-0.5em, -35.2ex)}]cov.south west)
    -| ([shift={(0em, -0.85ex)}]done.south east)
    -| ([shift={(3.2em, 6ex)}]decision2.north east)
    -- ([shift={(1.5em, -2.25ex)}]cov.south east)
    -| ([shift={(1.25em, 1.75ex)}]cov.north east)
    -- cycle
    ;
