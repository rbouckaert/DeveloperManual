...
\begin{figure}[!ht]
  \includegraphics[width=\linewidth]{figures/sbc_Yule_lambda.pdf}
  \caption{Rank-uniformity validation (RUV) results for the Brownian motion rate, $\Lambda$.
  ...
  For Scenario 1, there is no discernable pattern, while for Scenarios 2 and 3 over and underestimation are present, respectively.
