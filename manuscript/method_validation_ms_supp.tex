...
We also remind the reader that when carrying out coverage validation, there is nothing intrisically wrong with validating a model with a data set void of any signal -- the prior mean would be recovered for each parameter, and model correctness could still be in principle verified.
