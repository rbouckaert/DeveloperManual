...
Supplementary figure \ref{supfig:ruv} summarizes the results for the metrics listed in supplementary table \ref{suptab:dists}, for a simple Kingman's coalescent model.
