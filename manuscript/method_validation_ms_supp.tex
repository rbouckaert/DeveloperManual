...
\begin{figure}[!ht]
  \centering
   ...
   \caption{Coverage validation in phylogenetic tree topological space. Bars represent the counts of true clades (in 100 true, simulated trees) with their corresponding bin's posterior clade support, normalized by the total count of clades with that same posterior support value.}
