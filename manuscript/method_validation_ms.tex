...
\begin{figure}
  ...
  \caption{
    ...
    We show the prior (light shade blue) and replicate-averaged posterior (RAP, dark shade blue), also called the data-averaged posterior.
...
Newly implemented models can only profit from undergoing validation as we described here, but the need for model characterization efforts is contextual.
