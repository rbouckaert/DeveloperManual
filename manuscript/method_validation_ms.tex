...
\begin{abstract}
  ...
  We also introduce a suite of methods for automating validation protocols.
...
Much of the relevant information regarding good coding and statistical practices is out of reach of the average computational biologist, as it is spread across a large number of specialized material, and is often obfuscated by its technical and theoretical presentation.
...
\caption{Under a correctly implemented model, the number of true simulated values that fall within their corresponding $\alpha\times 100$\%-HPDs (coverage) is binomially distributed with $n$ trials and probability of success $\alpha$.
  Here we show the 95\% central interquantile intervals for the number of intervals covering the true parameter value under different credibility levels and numbers of replicates.
...
We expand on this point using a different and much simpler model (Supplementary Fig. 2; see rank-uniformity validation section below).
