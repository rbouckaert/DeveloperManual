...
simulations; \citealp{dawid82}; Fig. X).
...
signal, with mean posteriors falling around the prior mean if not
(Fig. X; we provide further guidelines and code examples for
calibrated validation in the supplementary material).

Finally, we note that a calibrated validation test is a multifarious
