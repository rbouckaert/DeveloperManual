...
\noindent \emph{\textcolor{purple}{My model implementation failed correctness tests, what now?}}
...
A correctly implemented inference machinery can nonetheless still fail a validation test if there is some unforeseen form of model misspecification (e.g., rejection sampling).
...
Ideally, guidelines should be provided for interpreting results obtained with a tool in the presence of known biases.
