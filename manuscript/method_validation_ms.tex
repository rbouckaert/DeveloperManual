...
We refer to the distribution produced through simulation as the
...
Here, using $S(M)$ itself as the proposal density is convenient because
it allows directing the validation task to just the model, otherwise
the potential malfunctioning of model and/or proposal mechanism are conflated
(see listing 2 in the supplementary material for an example, and the
section on validating operators below).
...
distribution (see listing 3 in supplementary material).
