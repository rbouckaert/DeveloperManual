...
\begin{figure}
  ...
  \caption{Flowchart of the validation of a Bayesian model.
    ...
    ``Parameter samples'' $\boldsymbol{\theta}'$ hold $n \times L$ elements, with each being one of the $L$ posterior samples for each of the $n$ parameter samples in $\boldsymbol{\theta}$.
