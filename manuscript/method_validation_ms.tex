...
\begin{abstract}
  ...
  \textcolor{blue}{We also introduce a suite of methods for automating validation protocols.}
...
\begin{tcolorbox}[breakable, width=\textwidth, colback=gray!10, boxrule=0pt,
  ...
  \small 
  One commonly used model in macroevolution for the study of continuous traits is the phylogenetic Brownian motion model (``PhyloBM'' in \textcolor{red}{Fig. X}; \citealt{felsenstein73}).
...
\begin{tabular}{cccc}
\hline
Credibility level (\%) & n (replicates) & Lower & Upper \\\hline
\rowcolor{LightGrey}                       & 100            & 84    & 95    \\
\rowcolor{LightGrey} 90                     & 200            & 171   & 188   \\
\rowcolor{LightGrey}                       & 500            & 436   & 463   \\
                       & 100            & 90    & 99    \\
95                     & 200            & 184   & 196   \\
                       & 500            & 465   & 484   \\
\rowcolor{LightGrey} 99                     & 100            & 97    & 100   \\
                       \rowcolor{LightGrey} & 200            & 195   & 200   \\
                       \rowcolor{LightGrey} & 500            & 490   & 499  \\ \hline
\end{tabular}
\end{center}
...
\begin{figure}
  ...
  \caption{
    Miscalibration patterns \textcolor{blue}{observable after inference with MCMC} \textcolor{red}{\st{in}}\textcolor{blue}{during} rank-uniformity validation (RUV).
    \textcolor{blue}{How to interpret the histogram of ranks (middle column) and ECDF plots (right-hand side column) is described in the main text.}
    \textcolor{blue}{
      ...
      Light-blue bands and horizontal black line (middle graphs in [a-c]) represent \textcolor{orange}{[Fill out]}.
      Light-blue ellipses (rightmost graphs in [a-c]) represent \textcolor{orange}{[Fill out]}.}}
...
\begin{figure}
  ...
  \caption{
    ...
    Panels in the top row show the histograms of $n=100$ ranks, for parameter $R$ in each scenario, obtained after 10\% burnin and thinning of posterior samples, 200 out of \textcolor{orange}{[Fill out]}.
...
Pessoal de Nível Superior - Brasil (CAPES) - Finance Code 001, and by
the School of Applied Mathematics \textcolor{orange}{of Fundaç\~{a}o Getulio Vargas [?]}.
