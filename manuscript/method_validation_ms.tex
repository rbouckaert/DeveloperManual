...
\begin{figure}%{l}{5.5cm}
  ...
  \caption{
    ...
    A random variable within a rectangular box signifies a parameter whose value is assumed by the user; these are normally nuisance hyperparameters, or parameters estimated elsewhere (e.g., the phylogeny in a comparative analysis) that are not of immediate interest.
