...
\begin{abstract}
  ...
  These tools must not only be efficient, but also correctly implemented.
  Both goals are difficult to achieve, among other reasons, because of a still embrionic literature on good statistical software development.
  This manuscript aims to fill this gap.
  ...
  We hope the guidelines presented here help sharpen the focus of discussions on (as well as elevate) expected standards of statistical software for biology.
\end{abstract}
