...
For instance, when the inference machinery leads to consistent overdispersed estimates, one gets a pattern of ranks concentrating towards the middle rank (Figure\ref{fig:ruv_conceptual}A).
When underdispersion is present, ranks tend to bunch up towards the ends (Figure\ref{fig:ruv_conceptual}B), creating a pattern of ``horns'', which can also be caused by high autocorrelation in the draws.
...
L.M.C  was financed in part by the Coordenação de Aperfeiçoamento de Pessoal de Nível Superior - Brasil (CAPES) - Finance Code 001 and acknowledges support by the School of Applied Mathematics.
