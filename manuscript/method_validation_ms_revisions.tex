...
$r^j$ \textcolor{red}{@Luiz: do we even need to introduce this $r$ term here?}
of the $j$-th sample from an MCMC chain ($\boldsymbol{\theta} = \{\theta^j, \theta^2, ..., \theta^L\}$)
...
\textcolor{red}{@Luiz: how about this: $\boldsymbol{\theta} = \{\theta^j: j \in [1, L]\}$? Or $\boldsymbol{\theta} = \{\theta^j: 1 \leq j \leq L\}$ }
