...
\textcolor{blue}{One way of looking at this involves noting that, if $\phi$ and $\phi_0$ have very many ($s$) tips, they will share a number of clades that is approximately Poisson distributed with rate $c_{\phi}$, the number of cherries in $\phi$ \citep{bryant09}.
