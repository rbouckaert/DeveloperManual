...
Total ordering of unlabeled topologies (shapes) is possible~\cite{Colijn2018,Maranca2024} and can be employed when running RUV on this space.
Here, we propose ways of mapping labeled trees to the real line and compute ranks.
Similarly, there seems to be no method described for evaluating the coverage of a labeled tree's topology.}
